...
class ChandraProcessor:
    ...
    def __init__(
        ...
        if not self.api_key:
            ...
            logger.error("      Add 'chandra_datalab.api_key' to sundarams_config.yaml")
        else:
            pass
